        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="<?php echo Utility::site_url(); ?>" class="site_title"><i class="fa fa-paw"></i> <span>Visit Site</span></a>
            </div>
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-desktop"></i> Pages <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <li><a href="createPage.php">Add Page</a></li>
                      <li><a href="#">Menu</a></li>
                    </ul>
                  </li>
                  <li><a><i class="fa fa-table"></i> Posts <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                  ...
                  <li><a><i class="fa fa-bar-chart-o"></i> Packages <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="package.php">All Packages</a></li>
                      <li><a href="createPackage.php">Add Package</a></li>
                    </ul>
                  </li>
                  <li><a><i class="fa fa-clone"></i>Booking Info<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="allBooking.php">Booking List</a></li>
                    </ul>
                  </li>
                  <li><a><i class="fa fa-clone"></i>Contact<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
